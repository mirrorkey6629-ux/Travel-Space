...
export function InfoRow({
  ...
  return <div className={`info-row${image ? ' info-row-with-image' : ' info-row-without-image'}${disabled ? ' info-row-disabled' : ''} ${className}`.trim()} aria-disabled={disabled || undefined}>
