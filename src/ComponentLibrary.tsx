...
const icons: IconName[] = ['add-circle', 'add-pin', 'add-plus', 'arrow-back', 'attractions', 'calendar-month', 'close', 'delete-forever', 'edit-location', 'edit', 'face', 'file-export', 'image', 'key', 'link', 'pin-home', 'planet', 'time']
    ...
    <main className="component-library">
      ...
      <div className="kit-page">
        <aside className="kit-sidebar glass">
          <div className="kit-sidebar-heading">
            <span className="kit-kicker">Travel Space</span>
            <h1>Компоненты</h1>
          </div>
        ...
        <div className="kit-content">
          <header className="kit-hero glass"><div><span className="kit-kicker">Travel Space</span><TypographyGroup title="Библиотека компонентов" text="Живые компоненты и доступные вариации, используемые в проекте." /></div></header>
        ...
        <Section id="lists" title="Списки и плашки" description="Карточки основного интерфейса">
          ...
          <Specimen name="Info field"><Variant label="Empty" wide><div className="info-field"><div className="info-copy"><b>🏨 Твой отель</b><span>Где будем жить</span></div><IconButton icon={<Icon name="add-plus" />} aria-label="Добавить" /></div></Variant><Variant label="Attached" wide><div className="info-field"><div className="info-copy"><b>🚅 Осака — Нара</b><span>ticket.pdf</span></div><IconButton icon={<Icon name="edit" />} aria-label="Редактировать" /></div></Variant></Specimen>
